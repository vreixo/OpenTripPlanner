...
public abstract class RoutingResource {
    ...
    /** Max averagePollution level to be admited. */
    @QueryParam("maxAveragePollution")
    protected Double maxAveragePollution;

    /** Max peakPollution level to be admited. */
    @QueryParam("maxPeakPollution")
    protected Double maxPeakPollution;

    /** Max averagePollen level to be admited. */
    @QueryParam("maxAveragePollen")
    protected Double maxAveragePollen;

    /** Max peakPollen level to be admited. */
    @QueryParam("maxPeakPollen")
    protected Double maxPeakPollen;

    /** Max averageNoise level to be admited. */
    @QueryParam("maxAverageNoise")
    protected Double maxAverageNoise;

    /** Max peakNoise level to be admited. */
    @QueryParam("maxPeakNoise")
    protected Double maxPeakNoise;
